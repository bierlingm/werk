...
└── #2 [2026-06] werk is a mature tool for practicing st...  [6/13] (3 released)
    ├── #3 [2026-05-30] PRESSURE werk is a FrankenTUI-fir...  [3/8] (2 released)
    ...
    │   ├── #76 TUI architectural consolidation — unified cursor, sing...  [0/1]
    │   │   └── #91 cursor can select desire and reality anchor zones — enab...
    │   └── #92 advisory lock is write-scoped, not session-scoped — CLI comm...
    ...
    │   ├── #52 CLI terminology and command structure reviewed and coherent ...
    ...
    ├── #82 werk has a graphical interface — browser or native Mac app...  [1/3]
    ...
    └── #90 the root level behaves as a quasi-tension — the field itse...  [0/1]
        └── #89 root-level epochs — the root tension tracks epoch boundaries...

Total: 89  Active: 53  Resolved: 30  Released: 6
```
