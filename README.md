...
```
└── #2 [2026-06] werk is a mature tool for practicing st...  [7/17] (3 released)
    ├── #10 [2026-05] PRESSURE CLI is a complete, honest interface to...  [8/13]
    ...
    │   ├── #100 cross-workspace addressing scheme exists — workspace-prefix...
    │   ├── #116 CLI polish pass — diff compact mode, epoch box-drawing, sur...
    │   └── #126 CLI command to install werk hooks into a repo
    ├── #90 [2026-05] the root level is a command center — structural ...  [0/1]
    │   └── #89 logbase — a searchable, queryable substrate of all prior des...
    ├── #3 [2026-05-30] PRESSURE werk is a FrankenTUI-fir...  [4/9] (2 released)
    │   ├── #15 [2026-04-15] TUI rebuilt around the operating envelope...  [0/3]
    │   │   ├── #18 [2026-04-10] survey view designed and implemented — temp...
    ...
    │   ├── #76 TUI architectural consolidation — unified cursor, sing...  [2/2]
    │   ├── #101 werk renders well on both dark and light terminal bac...  [0/5]
    │   │   ├── #102 all explicit background colors replaced with TRANSPAREN...
    │   │   ├── #103 terminal theme detected at startup — Dark or Light enum...
    │   │   ├── #104 dual palette in theme.rs — STYLES constructed condition...
    │   │   ├── #105 selection highlight adapts to terminal background — vis...
    │   │   └── #106 accent colors verified readable on both dark and light ...
    │   └── #127 the TUI never exhibits rendering corruption — no white glit...
    ├── #13 [2026-06] the conceptual foundation is imple...  [6/11] (1 released)
    │   ├── #16 [2026-04-10] complete state machine specification — all stat...
    │   ├── #20 data model extended — gesture grouping (gesture table)...  [2/3]
    │   │   └── #35 epoch and session lifecycle are fully operational
    │   ├── #46 threshold detection as independent structural signal l...  [0/3]
    │   │   ├── #129 signal state persistence and cross-query change detection
    │   │   ├── #130 horizon drift surfaced as structural signal — when a de...
    │   │   └── #131 TUI renders structural signals inline — overdue, contai...
    │   ├── #49 structural transformation gestures (split, merge, restructur...
    │   └── #128 deep addressability, expanded gesture vocabulary, and sessi...
    ├── #82 [2026-08] EXCEEDS_PARENT werk has a graphical interface — ...  [1/4]
    ...
    ├── #36 [2026-09] EXCEEDS_PARENT werk has a sustainable business m...  [0/7]
    │   ├── #37 [2026-07] werk is publicly known as the structural int...  [0/2]
    │   │   ├── #41 first public post about werk published — X post with Rem...
    │   │   └── #42 coherence offering designed — one-liner or agent prompt ...
    │   ├── #69 [2026-07] first $1000 earned through practical means —...  [0/3]
    ...
    ├── #51 werk has excellent documentation — the conceptual foundati...  [2/5]
    │   ├── #118 a practitioner's guide exists — covers the first tension th...
    │   ├── #119 MCP integration guide exists — how to connect agents, which...
    │   └── #120 crate-level rustdoc is generated and accessible — each publ...
    ├── #96 the global workspace is a meta-command-center across all workspa...
    └── #132 next release shipped — output taxonomy breaking change document...

Total: 127  Active: 66  Resolved: 54  Released: 7
```
