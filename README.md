...
└── #2 [2026-06] werk is a mature tool for practicing st...  [6/14] (3 released)
    ├── #10 [2026-05] PRESSURE CLI is a complete, honest interface to ...  [6/9]
    │   ├── #48 staging mechanism — propose/pending/confirm/reject for async...
    │   ├── #52 CLI is ergonomic, forgiving, and self-documenting — ac...  [3/4]
...
Total: 96  Active: 53  Resolved: 36  Released: 7
```
