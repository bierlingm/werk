...
└── #2 [2026-06] werk is a mature tool for practicing st...  [6/14] (3 released)
    ├── #10 [2026-05] PRESSURE CLI is a complete, honest interface to...  [7/10]
    │   ├── #48 staging mechanism — propose/pending/confirm/reject for async...
    │   ├── #52 CLI is ergonomic, forgiving, and self-documenting — ac...  [4/5]
    │   │   └── #100 cross-workspace addressing scheme exists — workspace-pr...
...
Total: 108  Active: 59  Resolved: 42  Released: 7
```
