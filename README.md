...
```
├── #2 [2026-06] werk is a mature tool for practicing st...  [6/16] (3 released)
│   ├── #10 [2026-05] PRESSURE CLI is a complete, honest interface to...  [8/12]
...
│   ├── #13 [2026-06] the conceptual foundation is imple...  [4/11] (1 released)
...
│   ├── #51 werk has excellent documentation — the conceptual foundati...  [0/5]
│   │   ├── #117 CLAUDE.md reflects current CLI capabilities — help grouping...
...
│   │   └── #121 design principles from implementation sessions are captured...
│   ├── #96 the global workspace is a meta-command-center across all workspa...
│   └── #122 repository is clean, well-organized, and intentional — ev...  [0/3]
│       ├── #123 .beads/ and .factory/ runtime artifacts gitignored — only c...
│       ├── #124 Rust edition choice is intentional and documented — either ...
│       └── #125 large assets (video/, research/archive/) have a clear stora...
└── #126 CLI command to install werk hooks into a repo

Total: 122  Active: 69  Resolved: 46  Released: 7
```
